...
return  [
	...
	// | 系统数据加密设置
	// +----------------------------------------------------------------------
	'data_auth_key' => '(gP4~E0^&l/Wp;LOTs.<7w$Xi5|v+N?hoR[=CjF)', //默认数据加密KEY
	'data_cache_key'=> '(gP4~E0^&l/Wp;LOTs.<7w$Xi5|v+N?hoR[=CjF)',
    // +----------------------------------------------------------------------
    // | UCenter客户端配置
    // +----------------------------------------------------------------------
    'uc_app_id'   => 1,   //应用ID
    'uc_api_type' =>'Model',    //可选值 Model / Service
    'uc_auth_key' =>'(gP4~E0^&l/Wp;LOTs.<7w$Xi5|v+N?hoR[=CjF)', //加密KEY
