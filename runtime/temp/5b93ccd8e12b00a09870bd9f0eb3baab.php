<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"D:\www\twothink\public/../application/admin/view/default/rentsell\create.html";i:1534071801;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="tab-wrap">
    <div class="tab-content">
        <!-- 表单 -->
        <form id="form" action="<?php echo url('store'); ?>" method="post" class="form-horizontal doc-modal-form" enctype="multipart/form-data">
            <!-- 基础 -->
            ...
            <div id="tab1" class="tab-pane in tab1">
                ...
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <input type="text" class="text " name="intro">
                    </div>
                </div>
                <div class="form-item cf">
