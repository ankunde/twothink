<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\www\twothink\public/../application/admin/view/default/rentsell\edit.html";i:1534072176;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="tab-wrap">
    <div class="tab-content">
        <!-- 表单 -->
        <form id="form" action="<?php echo url('save_edit'); ?>" method="post" class="form-horizontal doc-modal-form" enctype="multipart/form-data">
            <!-- 基础 -->
            <input type="hidden" name="id" value="<?php echo $rentsell['id']; ?>">
            <div id="tab1" class="tab-pane in tab1">
                <div class="form-item cf">
                    <label class="item-label">类型</label>
                    <div class="controls">
                        <select name="type">
                            <option value="1"<?php echo !empty($rentsell['type']) && $rentsell['type']==1?'selected':''; ?>>出租</option>
                            <option value="2"<?php echo !empty($rentsell['type']) && $rentsell['type']==2?'selected':''; ?>>出售</option>
                        </select>
                    </div>
                </div>
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <input type="text" class="text " name="title" value="<?php echo $rentsell['title']; ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">价格<span class="check-tips">（请输入模型的名称）</span></label>
                    <div class="controls">
                        <input type="text" class="text " name="price" value="<?php echo $rentsell['price']; ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">电话</label>
                    <div class="controls">
                        <input type="number" class="text " name="tel" value="<?php echo $rentsell['tel']; ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">简介<span class="check-tips"></span></label>
                    <div class="controls">
                        <input type="text" class="text " name="intro" value="<?php echo $rentsell['intro']; ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <label class="textarea">
                            <textarea name="content"><?php echo $rentsell['content']; ?></textarea>
                ...
                <div class="controls">
                    ...
                    <div class="upload-img-box">
                        ...
                        <div class="upload-pre-item"><img src="__ROOT__<?php echo get_cover_path($rentsell['img']); ?>" alt=""></div>
