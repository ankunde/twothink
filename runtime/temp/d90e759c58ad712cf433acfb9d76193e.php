<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:73:"D:\www\twothink\public/../application/admin/view/default/online\edit.html";i:1533777182;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="tab-wrap">
    <div class="tab-content">
        <!-- 表单 -->
        <form id="form" action="<?php echo url('save_edit'); ?>" method="post" class="form-horizontal doc-modal-form">
            <!-- 基础 -->
            ...
            <div id="tab1" class="tab-pane in tab1">
                <div class="form-item cf">
                    ...
                    <div class="controls">
                        <input type="text" class="text " name="title" value="<?php echo $repair['title']; ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">姓名<span class="check-tips">（请输入模型的名称）</span></label>
                    <div class="controls">
                        <input type="text" class="text " name="name" value="<?php echo $repair['name']; ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">电话</label>
                    <div class="controls">
                        <input type="number" class="text " name="tel" value="<?php echo $repair['tel']; ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">地址<span class="check-tips"></span></label>
                    <div class="controls">
                        <input type="text" class="text " name="address" value="<?php echo $repair['address']; ?>">
                    </div>
                </div>
                <div class="form-item cf">
                    <label class="item-label">内容<span class="check-tips"></span></label>
                    <div class="controls">
                        <textarea name="content" id="" cols="30" rows="10"><?php echo $repair['content']; ?>
                        </textarea>
                    </div>
                </div>
            </div>
