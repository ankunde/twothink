<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\www\twothink\public/../application/admin/view/default/rentsell\index.html";i:1534072279;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($rentsell) || (($rentsell instanceof \think\Collection || $rentsell instanceof \think\Paginator ) && $rentsell->isEmpty()))): if(is_array($rentsell) || $rentsell instanceof \think\Collection || $rentsell instanceof \think\Paginator): $i = 0; $__LIST__ = $rentsell;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
        <tr>
            <td><input class="ids row-selected" type="checkbox" name="ids[]" id="" value="<?php echo $value['id']; ?>"> </td>
            <td><?php echo $value['id']; ?></td>
            <td><?php echo $value['type']; ?></td>
            <td>
                <img src="__ROOT__<?php echo get_cover_path($value['img']); ?>">
            </td>
            <td><?php echo $value['title']; ?></td>
            <td><?php echo $value['price']; ?></td>
            <td><?php echo $value['tel']; ?></td>
            <td>
                <a href="<?php echo url('edit?id='.$value['id']); ?>">修改</a>
                <a href="<?php echo url('del?id='.$value['id']); ?>">删除</a>
            </td>
        </tr>
