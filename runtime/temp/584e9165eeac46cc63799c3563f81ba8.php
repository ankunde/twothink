<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\www\twothink\public/../application/admin/view/default/service\index.html";i:1534074397;s:73:"D:\www\twothink\public/../application/admin/view/default/public\base.html";i:1496373782;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="UTF-8">
...
<div class="data-table table-striped">
    <table>
        ...
        <tbody>
        <?php if(!(empty($check) || (($check instanceof \think\Collection || $check instanceof \think\Paginator ) && $check->isEmpty()))): if(is_array($check) || $check instanceof \think\Collection || $check instanceof \think\Paginator): $i = 0; $__LIST__ = $check;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$value): $mod = ($i % 2 );++$i;?>
        <tr>
            ...
            <td>
                <?php if($value['blood']==1): ?>
                本人
                <?php elseif($value['blood']==2): ?>
                亲戚
                <?php else: ?>
                租客
                <?php endif; ?>
            ...
            <td>
                ...
                <p>审核已通过</p>
                <?php else: ?>
                <a href="<?php echo url('edit?id='.$value['id']); ?>">点击审核通过</a>
                <?php endif; ?>
            </td>
        </tr>
